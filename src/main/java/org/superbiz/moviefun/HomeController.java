...
public class HomeController {
    ...
    public String setup(Map<String, Object> model) {
        ...
        new TransactionTemplate(moviesTransactionManager).execute(new TransactionCallbackWithoutResult() {
        ...
        new TransactionTemplate(albumsTransactionManager).execute(new TransactionCallbackWithoutResult() {
            protected void doInTransactionWithoutResult(TransactionStatus status) {
